...
ActiveRecord::Schema[7.0].define(version: 2022_11_22_180608) do
  ...
  create_table "microposts", force: :cascade do |t|
    ...
    t.integer "rating"
    t.index ["restaurant_id"], name: "index_microposts_on_restaurant_id"
  ...
  add_foreign_key "microposts", "restaurants"
